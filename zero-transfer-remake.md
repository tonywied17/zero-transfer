...
- Implement FTP provider using the existing parser-first work. Initial metadata, transfer-operation, and Docker-backed integration slices are in place; broader server compatibility remains.
...
3. Harden FTP transfer streaming against broader server behaviors and large-file backpressure.
