...
Defined in: [src/providers/ProviderTransferOperations.ts:56](https://github.com/tonywied17/zero-transfer/blob/6b0c0b0820cf5eac6e4cf75fd3bc783ddbf448fa/src/providers/ProviderTransferOperations.ts#L56)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="attempt"></a> `attempt` | `number` | One-based attempt number. | [`ProviderTransferRequest`](ProviderTransferRequest.md).[`attempt`](ProviderTransferRequest.md#attempt) | [src/transfers/TransferEngine.ts:30](https://github.com/tonywied17/zero-transfer/blob/6b0c0b0820cf5eac6e4cf75fd3bc783ddbf448fa/src/transfers/TransferEngine.ts#L30) |
...
| <a id="offset"></a> `offset?` | `number` | Resume offset for partial writes when supported by the provider. | - | [src/providers/ProviderTransferOperations.ts:62](https://github.com/tonywied17/zero-transfer/blob/6b0c0b0820cf5eac6e4cf75fd3bc783ddbf448fa/src/providers/ProviderTransferOperations.ts#L62) |
| <a id="signal"></a> `signal?` | `AbortSignal` | Abort signal active for this execution when supplied. | [`ProviderTransferRequest`](ProviderTransferRequest.md).[`signal`](ProviderTransferRequest.md#signal) | [src/transfers/TransferEngine.ts:32](https://github.com/tonywied17/zero-transfer/blob/6b0c0b0820cf5eac6e4cf75fd3bc783ddbf448fa/src/transfers/TransferEngine.ts#L32) |
| <a id="totalbytes"></a> `totalBytes?` | `number` | Expected total bytes for the content stream when known. | - | [src/providers/ProviderTransferOperations.ts:60](https://github.com/tonywied17/zero-transfer/blob/6b0c0b0820cf5eac6e4cf75fd3bc783ddbf448fa/src/providers/ProviderTransferOperations.ts#L60) |
| <a id="verification"></a> `verification?` | [`TransferVerificationResult`](TransferVerificationResult.md) | Verification details from the read side that a writer may preserve or compare. | - | [src/providers/ProviderTransferOperations.ts:64](https://github.com/tonywied17/zero-transfer/blob/6b0c0b0820cf5eac6e4cf75fd3bc783ddbf448fa/src/providers/ProviderTransferOperations.ts#L64) |
