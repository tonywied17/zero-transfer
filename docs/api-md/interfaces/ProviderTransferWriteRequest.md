...
Defined in: [src/providers/ProviderTransferOperations.ts:56](https://github.com/tonywied17/zero-transfer/blob/7122761ae2c4dd865e3f364ad3d5692c88bbfbb7/src/providers/ProviderTransferOperations.ts#L56)
...
| <a id="offset"></a> `offset?` | `number` | Resume offset for partial writes when supported by the provider. | - | [src/providers/ProviderTransferOperations.ts:62](https://github.com/tonywied17/zero-transfer/blob/7122761ae2c4dd865e3f364ad3d5692c88bbfbb7/src/providers/ProviderTransferOperations.ts#L62) |
...
| <a id="totalbytes"></a> `totalBytes?` | `number` | Expected total bytes for the content stream when known. | - | [src/providers/ProviderTransferOperations.ts:60](https://github.com/tonywied17/zero-transfer/blob/7122761ae2c4dd865e3f364ad3d5692c88bbfbb7/src/providers/ProviderTransferOperations.ts#L60) |
| <a id="verification"></a> `verification?` | [`TransferVerificationResult`](TransferVerificationResult.md) | Verification details from the read side that a writer may preserve or compare. | - | [src/providers/ProviderTransferOperations.ts:64](https://github.com/tonywied17/zero-transfer/blob/7122761ae2c4dd865e3f364ad3d5692c88bbfbb7/src/providers/ProviderTransferOperations.ts#L64) |
