...
Defined in: [src/providers/memory/MemoryProvider.ts:64](https://github.com/tonywied17/zero-transfer/blob/7122761ae2c4dd865e3f364ad3d5692c88bbfbb7/src/providers/memory/MemoryProvider.ts#L64)
...
| <a id="content"></a> `content?` | `string` \| `Uint8Array`\<`ArrayBufferLike`\> | Optional byte content for file entries. Strings are encoded as UTF-8. | - | [src/providers/memory/MemoryProvider.ts:68](https://github.com/tonywied17/zero-transfer/blob/7122761ae2c4dd865e3f364ad3d5692c88bbfbb7/src/providers/memory/MemoryProvider.ts#L68) |
...
| <a id="name"></a> `name?` | `string` | Entry basename. When omitted, it is derived from `path`. | - | [src/providers/memory/MemoryProvider.ts:66](https://github.com/tonywied17/zero-transfer/blob/7122761ae2c4dd865e3f364ad3d5692c88bbfbb7/src/providers/memory/MemoryProvider.ts#L66) |
