...
Defined in: [src/providers/memory/MemoryProvider.ts:57](https://github.com/tonywied17/zero-transfer/blob/4384f4bbe382c0bc97d7fe822fc67543a79294ce/src/providers/memory/MemoryProvider.ts#L57)
...
| <a id="content"></a> `content?` | `string` \| `Uint8Array`\<`ArrayBufferLike`\> | Optional byte content for file entries. Strings are encoded as UTF-8. | - | [src/providers/memory/MemoryProvider.ts:61](https://github.com/tonywied17/zero-transfer/blob/4384f4bbe382c0bc97d7fe822fc67543a79294ce/src/providers/memory/MemoryProvider.ts#L61) |
...
| <a id="name"></a> `name?` | `string` | Entry basename. When omitted, it is derived from `path`. | - | [src/providers/memory/MemoryProvider.ts:59](https://github.com/tonywied17/zero-transfer/blob/4384f4bbe382c0bc97d7fe822fc67543a79294ce/src/providers/memory/MemoryProvider.ts#L59) |
