...
Defined in: [src/types/public.ts:70](https://github.com/tonywied17/zero-transfer/blob/c68c4294e4eb621edd6d8f74af060620c8edd302/src/types/public.ts#L70)
...
| <a id="exists"></a> `exists` | `true` | Existence discriminator for successful stat operations. | - | [src/types/public.ts:72](https://github.com/tonywied17/zero-transfer/blob/c68c4294e4eb621edd6d8f74af060620c8edd302/src/types/public.ts#L72) |
...
| <a id="name"></a> `name` | `string` | Entry basename without parent directory segments. | [`RemoteEntry`](RemoteEntry.md).[`name`](RemoteEntry.md#name) | [src/types/public.ts:42](https://github.com/tonywied17/zero-transfer/blob/c68c4294e4eb621edd6d8f74af060620c8edd302/src/types/public.ts#L42) |
