...
Defined in: [src/client/operations.ts:151](https://github.com/tonywied17/zero-transfer/blob/4bee5127df8da342eff2f25e80fce7db7a313deb/src/client/operations.ts#L151)
...
| <a id="client"></a> `client` | [`TransferClient`](../classes/TransferClient.md) | Transfer client used to resolve both endpoint providers. | - | [src/client/operations.ts:153](https://github.com/tonywied17/zero-transfer/blob/4bee5127df8da342eff2f25e80fce7db7a313deb/src/client/operations.ts#L153) |
| <a id="destination"></a> `destination` | [`RemoteFileEndpoint`](RemoteFileEndpoint.md) | Destination remote endpoint. | - | [src/client/operations.ts:157](https://github.com/tonywied17/zero-transfer/blob/4bee5127df8da342eff2f25e80fce7db7a313deb/src/client/operations.ts#L157) |
...
| <a id="source"></a> `source` | [`RemoteFileEndpoint`](RemoteFileEndpoint.md) | Source remote endpoint. | - | [src/client/operations.ts:155](https://github.com/tonywied17/zero-transfer/blob/4bee5127df8da342eff2f25e80fce7db7a313deb/src/client/operations.ts#L155) |
